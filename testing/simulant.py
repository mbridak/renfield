...
bands = ("160", "80", "40", "20", "15", "28", "6", "2")
if args.band:
    if args.band in bands:
        BAND = args.band
    else:
        print('Allowed bands: "160", "80", "40", "20", "15", "28", "6", "2"')
        raise SystemExit(1)
else:
...
def log_contact():
    ...
    contact = {
        ...
        "Comment": "",
        "NR": 0,
        "Sect": generate_section(callsign),
        "Prec": "",
        "CK": 0,
        "ZN": 4,
        "SentNr": 0,
        ...
        "Run1Run2": "",
        "GridSquare": "",
        "Operator": STATION_CALL,
        "Continent": "NA",
        "RoverLocation": "",
        "RadioInterfaced": "",
        "NetworkedCompNr": 1,
        "NetBiosName": "PC_" + STATION_CALL,
        "IsOriginal": 1,
        "ID": unique_id,
        "CLAIMEDQSO": 1,
        "cmd": "POST",
...
def main():
    ...
    _udpwatch.start()
    print(f"Station: {STATION_CALL} on {BAND}Mhz {MODE}")
    send_status_udp()
    count = 0
    while True:
        count += 1
